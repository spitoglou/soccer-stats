...
class TestLoadDataset:
    ...
    def test_load_dataset_default_parameters(self, mocker):
        ...
        pd.read_csv.assert_called_once_with('https://www.football-data.co.uk/mmz4281/1819/ENG.csv',
    ...
    def test_load_dataset_custom_dateparser_and_fields(self, mocker):
        ...
        # Assert that pd.read_csv was called with the correct arguments
        pd.read_csv.assert_called_once_with('https://www.football-data.co.uk/mmz4281/1920/ESP.csv',
                                            parse_dates=['Date'], index_col='Date', date_parser=custom_dateparser)
    ...
    def test_load_dataset_custom_country_and_period(self, mocker):
        ...
        # Assert that pd.read_csv was called with the correct arguments
        pd.read_csv.assert_called_once_with('https://www.football-data.co.uk/mmz4281/1718/GER.csv',
                                            parse_dates=['Date'], index_col='Date', date_parser=dateparser1819)
    ...
    def test_load_dataset_invalid_fields(self, mocker):
        ...
        # Assert that pd.read_csv was called with the correct arguments
        pd.read_csv.assert_called_once_with('https://www.football-data.co.uk/mmz4281/1920/ITA.csv',
                                            parse_dates=['Date'], index_col='Date', date_parser=dateparser1819)
